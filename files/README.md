...
| 기준 | 신호 | 타겟 시점 |
|------|------|-----------|
| 저평가 우량주 | 업종 대비 PER/PBR 할인 + 수익성 | 장기 |
| 테마 급부상 | 테마군 거래량 급증 + 섹터 강도 | 단기 |
| 호재 모멘텀 | 비정상 거래량 + 모멘텀 + 감성 (⚠️고위험) | 단기 |
| 퀀트·차트 신호 | RSI 반등 + MACD 골든크로스 + 볼린저 | 단기 |
| 목표가 갭 | 컨센서스 목표가 대비 상승여력 | 중기 |
| 간접 수혜주 | 대장주 급등 대비 미반영 갭 | 중기 |
| 꾸준한 실적 성장 | 연속 증가 분기 + YoY | 장기 |
| 신뢰 소스 언급 | 화이트리스트 소스 언급 빈도 | 중기 |
